...
# FIXED CORS: Added localhost:5500 (your frontend port)
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",
        ...
        "http://127.0.0.1:3000",
        "http://172.20.10.12:5500",
        "http://127.0.0.1:5500",
        "http://localhost:5500",   # <-- ADDED for frontend PWA
        "http://127.0.0.1:5500"    # <-- also added for consistency
    ],
...
# NEW: Health check endpoint (called by frontend)
@app.get("/api/health")
...
if __name__ == "__main__":
    ...
    print("🌐 Frontend: http://localhost:3000 (or http://localhost:5500)")
